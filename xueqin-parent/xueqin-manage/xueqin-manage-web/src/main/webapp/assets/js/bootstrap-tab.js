var addTabs = function (options) {
    ...
    if (!$("#" + id)[0]) {
        ...
        //创建新TAB的title
        title = '<li role="presentation" id="tab_' + id + '"><a href="#' + id + '" aria-controls="' + id + '" role="tab" data-toggle="tab">' + options.title+'<i class="ace-icon fa fa-remove" tabclose="'+id+'"></i>';
        //是否允许关闭
        ...
        if (options.content) {
            ...
            content = '<div role="tabpanel" class="tab-pane" id="' + id + '"><iframe src="' + options.url + '" width="100%" height="' + mainHeight +
                    '" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes" style="overflow:visible;"></iframe></div>';
        }
        //加入TABS
